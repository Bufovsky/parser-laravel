...
@section('title', 'Utwórz użytkownika')
@push('footer')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-10">
                    <div class="form-group form-group-feedback form-group-feedback-left">
                        <input id="name" type="text" class="{{ $errors->has('name') ? 'border-danger' : '' }} form-control" name="name" value="{{ old('name') }}" required autofocus>
            ...
            <div class="row{{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <div class="col-md-10">
                    <div class="form-group form-group-feedback form-group-feedback-left">
                        <input id="email" type="email" class="{{ $errors->has('email') ? 'border-danger' : '' }} form-control" name="email" value="{{ old('email') }}" required>
            ...
            <div class="row{{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <div class="col-md-10">
                    <div class="form-group form-group-feedback form-group-feedback-left">
                        <input id="password" type="password" class="{{ $errors->has('password') ? 'border-danger' : '' }} form-control" name="password" value="{{ old('password') }}" required>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="form-group form-group-feedback form-group-feedback-left">
                        <input id="password-confirm" type="password" class="{{ $errors->has('password') ? 'border-danger' : '' }} form-control" name="password_confirmation" value="{{ old('password_confirmation') }}" required>
            ...
            <div class="row">
				...
				<div class="col-md-10">
					<div class="btn-group btn-group-justified">
						...
						<input type="radio" name="access" value="0" class="hidden"/>

						<div class="btn-group">
							<button type="button" class="btn bg-slate" onclick="selectButton('access', 1)">Administrator</button>
						</div>
						<input type="radio" name="access" value="1" class="hidden"/>
                    </div>
